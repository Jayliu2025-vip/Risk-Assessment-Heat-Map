...
| [pypdfium2](https://github.com/pypdfium2-team/pypdfium2) 5.13.0 | Apache-2.0 | [pypdfium2 docs](https://pypdfium2.readthedocs.io/) | Yes: wheels can carry native PDFium binaries; PDFium is separately licensed under BSD-3-Clause | Preserve pypdfium2 Apache-2.0 terms and the PDFium BSD-3-Clause notice. Audit the wheel's bundled PDFium license files and copy them to `THIRD_PARTY_NOTICES/` at packaging time. |
