...
| [Pillow](https://github.com/python-pillow/Pillow) 12.3.0 | MIT-CMU | [python-pillow.org](https://python-pillow.org/) | Yes: wheels may contain compiled image-codec extensions | Include Pillow's license text and copyright notice, plus notices for any codecs actually redistributed. |
...
installer license, CPython's complete versioned `Doc/license.rst`, and the exact OpenSSL, SQLite, Tcl, Tk, zlib, libffi, bzip2,
XZ/liblzma, libmpdec and Expat license or public-domain notices used by that build. The
